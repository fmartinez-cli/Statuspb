...
$titulofinal = str_replace($actual, $nuevo, $titulo);
 $query="INSERT INTO imagenes (user, titulo, imagen, descripcion, Area) Values ('$_SESSION[Nombre]', '$titulofinal', '$ruta', '$Comentariofinal', 'TEST') ";
