...
<tr>	
<td id="open21" class="_<?php echo ($contr21['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr21['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr21['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup21" class="link1" href="modales.php?pb=<?php echo "$NoSerie21"; ?>&tr=TR03-21" rel="moodalbox"><div class="link">TR03-21 <hr> <br><?php echo $Prueba21; echo "</br>".$NoSerie21; ?></div></a></td>
<td id="open22" class="_<?php echo ($contr22['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr22['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr22['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup22" class="link1" href="modales.php?pb=<?php echo "$NoSerie22"; ?>&tr=TR03-22" rel="moodalbox"><div class="link">TR03-22 <hr> <br><?php echo $Prueba22; echo "</br>".$NoSerie22; ?></div></a></td>
<td id="open23" class="_<?php echo ($contr23['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr23['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr23['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup23" class="link1" href="modales.php?pb=<?php echo "$NoSerie23"; ?>&tr=TR03-23" rel="moodalbox"><div class="link">TR03-23 <hr> <br><?php echo $Prueba23; echo "</br>".$NoSerie23; ?></div></a></td>
<td id="open24" class="_<?php echo ($contr24['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr24['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr24['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup24" class="link1" href="modales.php?pb=<?php echo "$NoSerie24"; ?>&tr=TR03-24" rel="moodalbox"><div class="link">TR03-24 <hr> <br><?php echo $Prueba24; echo "</br>".$NoSerie24; ?></div></a></td>
<td id="open25" class="_<?php echo ($contr25['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr25['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr25['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup25" class="link1" href="modales.php?pb=<?php echo "$NoSerie25"; ?>&tr=TR03-25" rel="moodalbox"><div class="link">TR03-25 <hr> <br><?php echo $Prueba25; echo "</br>".$NoSerie25; ?></div></a></td>
<tr>
<td id="open26" class="_<?php echo ($contr26['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr26['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr26['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup26" class="link1" href="modales.php?pb=<?php echo "$NoSerie26"; ?>&tr=TR03-26" rel="moodalbox"><div class="link">TR03-26 <hr> <br><?php echo $Prueba26; echo "</br>".$NoSerie26; ?></div></a></td>
<td id="open27" class="_<?php echo ($contr27['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr27['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr27['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup27" class="link1" href="modales.php?pb=<?php echo "$NoSerie27"; ?>&tr=TR03-27" rel="moodalbox"><div class="link">TR03-27 <hr> <br><?php echo $Prueba27; echo "</br>".$NoSerie27; ?></div></a></td>
<td id="open28" class="_<?php echo ($contr28['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr28['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr28['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup28" class="link1" href="modales.php?pb=<?php echo "$NoSerie28"; ?>&tr=TR03-28" rel="moodalbox"><div class="link">TR03-28 <hr> <br><?php echo $Prueba28; echo "</br>".$NoSerie28; ?></div></a></td>
<td id="open29" class="_<?php echo ($contr29['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr29['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr29['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup29" class="link1" href="modales.php?pb=<?php echo "$NoSerie29"; ?>&tr=TR03-29" rel="moodalbox"><div class="link">TR03-29 <hr> <br><?php echo $Prueba29; echo "</br>".$NoSerie29; ?></div></a></td>
<td id="open30" class="_<?php echo ($contr30['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr30['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr30['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup30" class="link1" href="modales.php?pb=<?php echo "$NoSerie30"; ?>&tr=TR03-30" rel="moodalbox"><div class="link">TR03-30 <hr> <br><?php echo $Prueba30; echo "</br>".$NoSerie30; ?></div></a></td>
...
<section>
        ...
        <div>
            ...
            <div class="iframe-container">
                <iframe src="tabla_bahia3.php" frameborder="0" scrolling="no"></iframe>
