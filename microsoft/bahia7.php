...
<table>
	<tr>
	<td id="open61" class="_<?php echo ($contr61['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr61['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr61['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup61" class="link1" href="modales.php?pb=<?php echo "$NoSerie61"; ?>&tr=TR07-61" rel="moodalbox"><div class="link">TR07-61 <hr> <br><?php echo $Prueba61; echo "</br>".$NoSerie61; ?></div></a></td>
	<td id="open62" class="_<?php echo ($contr62['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr62['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr62['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup62" class="link1" href="modales.php?pb=<?php echo "$NoSerie62"; ?>&tr=TR07-62" rel="moodalbox"><div class="link">TR07-62 <hr> <br><?php echo $Prueba62; echo "</br>".$NoSerie62; ?></div></a></td>
	<td id="open63" class="_<?php echo ($contr63['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr63['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr63['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup63" class="link1" href="modales.php?pb=<?php echo "$NoSerie63"; ?>&tr=TR07-63" rel="moodalbox"><div class="link">TR07-63 <hr> <br><?php echo $Prueba63; echo "</br>".$NoSerie63; ?></div></a></td>
	<td id="open64" class="_<?php echo ($contr64['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr64['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr64['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup64" class="link1" href="modales.php?pb=<?php echo "$NoSerie64"; ?>&tr=TR07-64" rel="moodalbox"><div class="link">TR07-64 <hr> <br><?php echo $Prueba64; echo "</br>".$NoSerie64; ?></div></a></td>
	<td id="open65" class="_<?php echo ($contr65['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr65['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr65['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup65" class="link1" href="modales.php?pb=<?php echo "$NoSerie65"; ?>&tr=TR07-65" rel="moodalbox"><div class="link">TR07-65 <hr> <br><?php echo $Prueba65; echo "</br>".$NoSerie65; ?></div></a></td>
	</tr>
	<td id="open66" class="_<?php echo ($contr66['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr66['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr66['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup66" class="link1" href="modales.php?pb=<?php echo "$NoSerie66"; ?>&tr=TR07-66" rel="moodalbox"><div class="link">TR07-66 <hr> <br><?php echo $Prueba66; echo "</br>".$NoSerie66; ?></div></a></td>
	<td id="open67" class="_<?php echo ($contr67['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr67['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr67['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup67" class="link1" href="modales.php?pb=<?php echo "$NoSerie67"; ?>&tr=TR07-67" rel="moodalbox"><div class="link">TR07-67 <hr> <br><?php echo $Prueba67; echo "</br>".$NoSerie67; ?></div></a></td>
	<td id="open68" class="_<?php echo ($contr68['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr68['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr68['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup68" class="link1" href="modales.php?pb=<?php echo "$NoSerie68"; ?>&tr=TR07-68" rel="moodalbox"><div class="link">TR07-68 <hr> <br><?php echo $Prueba68; echo "</br>".$NoSerie68; ?></div></a></td>
	<td id="open69" class="_<?php echo ($contr69['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr69['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr69['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup69" class="link1" href="modales.php?pb=<?php echo "$NoSerie69"; ?>&tr=TR07-69" rel="moodalbox"><div class="link">TR07-69 <hr> <br><?php echo $Prueba69; echo "</br>".$NoSerie69; ?></div></a></td>
	<td id="open70" class="_<?php echo ($contr70['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr70['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr70['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup70" class="link1" href="modales.php?pb=<?php echo "$NoSerie70"; ?>&tr=TR07-70" rel="moodalbox"><div class="link">TR07-70 <hr> <br><?php echo $Prueba70; echo "</br>".$NoSerie70; ?></div></a></td>
...
<section>
        ...
        <div>
            ...
            <div class="iframe-container">
                <iframe src="tabla_bahia7.php" frameborder="0" scrolling="no"></iframe>
