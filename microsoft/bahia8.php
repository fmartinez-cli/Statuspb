...
<table>
	<tr>
	<td id="open71" class="_<?php echo ($contr71['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr71['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr71['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup71" class="link1" href="modales.php?pb=<?php echo "$NoSerie71"; ?>&tr=TR08-71" rel="moodalbox"><div class="link">TR08-71 <hr> <br><?php echo $Prueba71; echo "</br>".$NoSerie71; ?></div></a></td>
	<td id="open72" class="_<?php echo ($contr72['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr72['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr72['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup72" class="link1" href="modales.php?pb=<?php echo "$NoSerie72"; ?>&tr=TR08-72" rel="moodalbox"><div class="link">TR08-72 <hr> <br><?php echo $Prueba72; echo "</br>".$NoSerie72; ?></div></a></td>
	<td id="open73" class="_<?php echo ($contr73['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr73['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr73['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup73" class="link1" href="modales.php?pb=<?php echo "$NoSerie73"; ?>&tr=TR08-73" rel="moodalbox"><div class="link">TR08-73 <hr> <br><?php echo $Prueba73; echo "</br>".$NoSerie73; ?></div></a></td>
	<td id="open74" class="_<?php echo ($contr74['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr74['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr74['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup74" class="link1" href="modales.php?pb=<?php echo "$NoSerie74"; ?>&tr=TR08-74" rel="moodalbox"><div class="link">TR08-74 <hr> <br><?php echo $Prueba74; echo "</br>".$NoSerie74; ?></div></a></td>
	<td id="open75" class="_<?php echo ($contr75['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr75['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr75['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup75" class="link1" href="modales.php?pb=<?php echo "$NoSerie75"; ?>&tr=TR08-75" rel="moodalbox"><div class="link">TR08-75 <hr> <br><?php echo $Prueba75; echo "</br>".$NoSerie75; ?></div></a></td>
	</tr>
	<td id="open76" class="_<?php echo ($contr76['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr76['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr76['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup76" class="link1" href="modales.php?pb=<?php echo "$NoSerie76"; ?>&tr=TR08-76" rel="moodalbox"><div class="link">TR08-76 <hr> <br><?php echo $Prueba76; echo "</br>".$NoSerie76; ?></div></a></td>
	<td id="open77" class="_<?php echo ($contr77['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr77['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr77['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup77" class="link1" href="modales.php?pb=<?php echo "$NoSerie77"; ?>&tr=TR08-77" rel="moodalbox"><div class="link">TR08-77 <hr> <br><?php echo $Prueba77; echo "</br>".$NoSerie77; ?></div></a></td>
	<td id="open78" class="_<?php echo ($contr78['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr78['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr78['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup78" class="link1" href="modales.php?pb=<?php echo "$NoSerie78"; ?>&tr=TR08-78" rel="moodalbox"><div class="link">TR08-78 <hr> <br><?php echo $Prueba78; echo "</br>".$NoSerie78; ?></div></a></td>
	<td id="open79" class="_<?php echo ($contr79['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr79['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr79['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup79" class="link1" href="modales.php?pb=<?php echo "$NoSerie79"; ?>&tr=TR08-79" rel="moodalbox"><div class="link">TR08-79 <hr> <br><?php echo $Prueba79; echo "</br>".$NoSerie79; ?></div></a></td>
	<td id="open80" class="_<?php echo ($contr80['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr80['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr80['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup80" class="link1" href="modales.php?pb=<?php echo "$NoSerie80"; ?>&tr=TR08-80" rel="moodalbox"><div class="link">TR08-80 <hr> <br><?php echo $Prueba80; echo "</br>".$NoSerie80; ?></div></a></td>
...
<section>
        ...
        <div>
            ...
            <div class="iframe-container">
                <iframe src="tabla_bahia8.php" frameborder="0" scrolling="no"></iframe>
