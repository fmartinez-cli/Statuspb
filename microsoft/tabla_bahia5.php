            ...
            <div class='caja'>
                <form id='racks-form' method='POST' action='update_comentariosJRS.php'>
                    <table width='100%' style='opacity:.9 ;' class='tablaST'>
                        <caption style='background-color:#3e3e3e; padding:5px;'><h1 style='color:white;'>Bahia 5</h1></caption>
                        <tr>
                            <th>Locacion</th>
                            <th>No Serie</th>
                            <th>WO</th>
