...
$update=$enlace->query("UPDATE racks set Corriendo='0' where NoSerie = '$noserieold'");
		$delete=$enlace->query("DELETE FROM racks  where NoSerie = '$noserieold'");
		$delete2=$enlace->query("DELETE FROM pruebas  where NoSerie = '$noserieold'");
		$delete3=$enlace->query("DELETE FROM comentarios  where NoSerie = '$noserieold'");
		$delete=$enlace->query("DELETE FROM racksterminados  where NoSerie = '$noserieold'");
		$delete2=$enlace->query("DELETE FROM pruebasterminados  where NoSerie = '$noserieold'");
