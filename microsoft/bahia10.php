...
<table>
	<tr>
	<td id="open91" class="_<?php echo ($contr91['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr91['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr91['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup91" class="link1" href="modales.php?pb=<?php echo "$NoSerie91"; ?>&tr=TR10-91" rel="moodalbox"><div class="link">TR10-91 <hr> <br><?php echo $Prueba91; echo "</br>".$NoSerie91; ?></div></a></td>
	<td id="open92" class="_<?php echo ($contr92['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr92['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr92['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup92" class="link1" href="modales.php?pb=<?php echo "$NoSerie92"; ?>&tr=TR10-92" rel="moodalbox"><div class="link">TR10-92 <hr> <br><?php echo $Prueba92; echo "</br>".$NoSerie92; ?></div></a></td>
	<td id="open93" class="_<?php echo ($contr93['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr93['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr93['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup93" class="link1" href="modales.php?pb=<?php echo "$NoSerie93"; ?>&tr=TR10-93" rel="moodalbox"><div class="link">TR10-93 <hr> <br><?php echo $Prueba93; echo "</br>".$NoSerie93; ?></div></a></td>
	<td id="open94" class="_<?php echo ($contr94['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr94['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr94['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup94" class="link1" href="modales.php?pb=<?php echo "$NoSerie94"; ?>&tr=TR10-94" rel="moodalbox"><div class="link">TR10-94 <hr> <br><?php echo $Prueba94; echo "</br>".$NoSerie94; ?></div></a></td>
	<td id="open95" class="_<?php echo ($contr95['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr95['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr95['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup95" class="link1" href="modales.php?pb=<?php echo "$NoSerie95"; ?>&tr=TR10-95" rel="moodalbox"><div class="link">TR10-95 <hr> <br><?php echo $Prueba95; echo "</br>".$NoSerie95; ?></div></a></td>
	</tr>
	<td id="open96" class="_<?php echo ($contr96['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr96['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr96['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup96" class="link1" href="modales.php?pb=<?php echo "$NoSerie96"; ?>&tr=TR10-96" rel="moodalbox"><div class="link">TR10-96 <hr> <br><?php echo $Prueba96; echo "</br>".$NoSerie96; ?></div></a></td>
	<td id="open97" class="_<?php echo ($contr97['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr97['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr97['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup97" class="link1" href="modales.php?pb=<?php echo "$NoSerie97"; ?>&tr=TR10-97" rel="moodalbox"><div class="link">TR10-97 <hr> <br><?php echo $Prueba97; echo "</br>".$NoSerie97; ?></div></a></td>
	<td id="open98" class="_<?php echo ($contr98['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr98['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr98['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup98" class="link1" href="modales.php?pb=<?php echo "$NoSerie98"; ?>&tr=TR10-98" rel="moodalbox"><div class="link">TR10-98 <hr> <br><?php echo $Prueba98; echo "</br>".$NoSerie98; ?></div></a></td>
	<td id="open99" class="_<?php echo ($contr99['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr99['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr99['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup99" class="link1" href="modales.php?pb=<?php echo "$NoSerie99"; ?>&tr=TR10-99" rel="moodalbox"><div class="link">TR10-99 <hr> <br><?php echo $Prueba99; echo "</br>".$NoSerie99; ?></div></a></td>
	<td id="open100" class="_<?php echo ($contr100['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr100['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr100['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup100" class="link1" href="modales.php?pb=<?php echo "$NoSerie100"; ?>&tr=TR10-100" rel="moodalbox"><div class="link">TR10-100 <hr> <br><?php echo $Prueba100; echo "</br>".$NoSerie100; ?></div></a></td>
...
<section>
        ...
        <div>
            ...
            <div class="iframe-container">
                <iframe src="tabla_bahia10.php" frameborder="0" scrolling="no"></iframe>
