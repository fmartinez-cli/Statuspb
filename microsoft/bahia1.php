...
<head>
	...
	<!-- *********************Stylos *********************-->
	<link rel="stylesheet" href="css/tabla_tecnicos.css">
...
<!-------------------------------------------------- CUADROS DE TR's PARA LOS TECNICOS--------------------------------------------------------------------------------------------------------------------------------------------->
					<table class='tabla_tecnicos'>
						...
						<td id="open1" class="_<?php echo ($contr1['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr1['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr1['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup1" class="link1" href="modales.php?pb=<?php echo "$NoSerie1"; ?>&tr=TR01-01" rel="moodalbox"><div class="link">TR01-01 <hr> <br><?php echo $Prueba1; echo "</br>".$NoSerie1; ?></div></a></td>
						<td id="open2" class="_<?php echo ($contr2['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr2['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr2['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup2" class="link1" href="modales.php?pb=<?php echo "$NoSerie2"; ?>&tr=TR01-02" rel="moodalbox"><div class="link">TR01-02 <hr> <br><?php echo $Prueba2; echo "</br>".$NoSerie2; ?></div></a></td>
						<td id="open3" class="_<?php echo ($contr3['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr3['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr3['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup3" class="link1" href="modales.php?pb=<?php echo "$NoSerie3"; ?>&tr=TR01-03" rel="moodalbox"><div class="link">TR01-03 <hr> <br><?php echo $Prueba3; echo "</br>".$NoSerie3; ?></div></a></td>
						<td id="open4" class="_<?php echo ($contr4['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr4['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr4['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup4" class="link1" href="modales.php?pb=<?php echo "$NoSerie4"; ?>&tr=TR01-04" rel="moodalbox"><div class="link">TR01-04 <hr> <br><?php echo $Prueba4; echo "</br>".$NoSerie4; ?></div></a></td>
						<td id="open5" class="_<?php echo ($contr5['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr5['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr5['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup5" class="link1" href="modales.php?pb=<?php echo "$NoSerie5"; ?>&tr=TR01-05" rel="moodalbox"><div class="link">TR01-05 <hr> <br><?php echo $Prueba5; echo "</br>".$NoSerie5; ?></div></a></td>
						<tr>
						<td id="open6" class="_<?php echo ($contr6['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr6['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr6['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup6" class="link1" href="modales.php?pb=<?php echo "$NoSerie6"; ?>&tr=TR01-06" rel="moodalbox"><div class="link">TR01-06 <hr> <br><?php echo $Prueba6; echo "</br>".$NoSerie6; ?></div></a></td>
						<td id="open7" class="_<?php echo ($contr7['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr7['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr7['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup7" class="link1" href="modales.php?pb=<?php echo "$NoSerie7"; ?>&tr=TR01-07" rel="moodalbox"><div class="link">TR01-07 <hr> <br><?php echo $Prueba7; echo "</br>".$NoSerie7; ?></div></a></td>
						<td id="open8" class="_<?php echo ($contr8['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr8['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr8['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup8" class="link1" href="modales.php?pb=<?php echo "$NoSerie8"; ?>&tr=TR01-08" rel="moodalbox"><div class="link">TR01-08 <hr> <br><?php echo $Prueba8; echo "</br>".$NoSerie8; ?></div></a></td>
						<td id="open9" class="_<?php echo ($contr9['Modelo'] == 'Microsoft 8.2' ? 'trs'	: ($contr9['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr9['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup9" class="link1" href="modales.php?pb=<?php echo "$NoSerie9"; ?>&tr=TR01-09" rel="moodalbox"><div class="link">TR01-09 <hr> <br><?php echo $Prueba9; echo "</br>".$NoSerie9; ?></div></a></td>
						<td id="open10"class="_<?php echo ($contr10['Modelo'] == 'Microsoft 8.2' ? 'trs' : ($contr10['Modelo'] == 'Microsoft 8.3' ? 'trs2' : ($contr10['Modelo'] == 'NPI' ? 'trs4' : 'trs3')));?> hvr-bob hvr-underline-from-center"><a id="popup10" class="link1" href="modales.php?pb=<?php echo "$NoSerie10"; ?>&tr=TR01-10" rel="moodalbox"><div class="link">TR01-10 <hr> <br><?php echo $Prueba10; echo "</br>".$NoSerie10; ?></div></a></td>
...
<section>
    <div>
        <style>
            .iframe-container {
                position: relative;
                padding-bottom: 60%; /* Ajusta el porcentaje según el tamaño deseado del iframe */
                height: 0;
                width: 100%;
                overflow: hidden;
            }
        ...
        <div class="iframe-container">
            <iframe src="tabla_bahia1.php"></iframe>
        </div>
    </div>
</section>
