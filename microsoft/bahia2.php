...
<!-------------------------------------------------- Leyenda de los tipos de Racks en las bahias--------------------------------------------------------------------------------------------------------------------------------------------->
  ...
  <div class="caja">
    ...
    <div style="opacity:.7; float:left; text-align:center; height:33px; margin-top:5px; padding:5px; background-color:#e26715; font-weight:bold; color:white;"><i class="fa fa-server" aria-hidden="true"></i> Microsoft NPI</div>
...
<section>
        ...
        <div>
            ...
            <div class="iframe-container">
                <iframe src="tabla_bahia2.php" frameborder="0" scrolling="no"></iframe>
