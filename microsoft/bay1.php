            ...
            <div class="container">
                <header class="clearfix header2">
                    ...
                    <div style="position:absolute; right:5px; top:5px;">
                        <a href="admin_panel.php"><img width="25" src="img/admin.png"></a>
                    </div>
                    <?php endif; ?>
                </header>
            </div>
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay1.php">
                            <i class="fas fa-location-dot me-2"></i>Bay 1</a></li>
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay2.php">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay3.php">
                            <i class="fas fa-location-dot me-2"></i>Bay 3</a></li>
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay4.php">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay5.php">
                            <i class="fas fa-location-dot me-2"></i>Bay 5</a></li>
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay6.php">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay7.php">
                            <i class="fas fa-location-dot me-2"></i>Bay 7</a></li>
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay8.php">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay9.php">
                            <i class="fas fa-location-dot me-2"></i>Bay 9</a></li>
                        <li><a class="dropdown-item" href="/Statuspb/microsoft/bay10.php">
...
<section>
    ...
    <div class="iframe-container">
        <iframe src="bay_table.php" loading="lazy"></iframe>
    </div>
</section>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    modalEl.addEventListener('show.bs.modal', function(e) {
        ...
        fetch('modals.php?pb=' + encodeURIComponent(serie) +
