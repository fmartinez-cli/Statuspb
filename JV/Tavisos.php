...
<section>
	<div class="grupo web-tabla avisoss">
		...
		<div class="caja" style="padding-top:20px;"><center><h1>Avisos</h1><br></center>
		<hr><br><br>
		</div>

				<?php
				$query=mysqli_query($enlace, "SELECT * FROM imagenes WHERE Area='JV' order by id desc limit 20");
				while($row = mysqli_fetch_array($query)){
				 ?>
				<div title="Leer mas" class=" caja web-1-3 centrar">

				<?php echo "<h2>". $row['titulo']."</h2>";

				 ?>
				<img class="centrar" style=" height:100px;" src="<?php if ($row['imagen']=='../upload/'){echo"../upload/Default.jpg";}else{echo $row['imagen'];}  ?>" >
