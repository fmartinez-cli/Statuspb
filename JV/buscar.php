...
<div class="caja"><div class="caja web-50" style="float:right;"><center><br><br><br><h2>Buscar WO</h2></center>
		...
		$con01=mysqli_query($enlace, "SELECT * FROM racksterminadosjv WHERE WO='$WO'");
		$con0=mysqli_query($enlace, "SELECT * FROM racksjv WHERE WO='$WO'");

		$con1=mysqli_query($enlace, "SELECT * FROM racksjv WHERE WO='$WO'");
		$con2=mysqli_query($enlace, "SELECT * FROM racksterminadosjv WHERE WO='$WO'");

		if ($cons1=mysqli_fetch_row($con1)||$cons2=mysqli_fetch_row($con2)) {
			$contador=1;
					...
					$consultawo=mysqli_query($enlace, "SELECT * from racksjv where WO='$WO'");
              ...
              while($datoswop=mysqli_fetch_row($consultawop)){
					...
					$consultawot=mysqli_query($enlace, "SELECT * from racksterminadosjv where WO='$WO' ");
            ...
            while($datoswotp=mysqli_fetch_row($consultawotp)){
				...
				echo '<center><div><h2 style="color:white; background:#D91E18; margin-top:300px; padding:10px; width:500px; ">No se encontro la WO</h2></div></center>';
