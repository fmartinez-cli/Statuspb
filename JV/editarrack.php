...
if (!isset($_SESSION['Nombre'])){
    ...
    <script>
     function Validar(NoSerie)
     {
       $.ajax({
         url: "editarrackbackend.php",
         type: "POST",
         data: "NoSerie="+NoSerie,
...
<tr><th><h2 style="color:#CC263A;">Editar rack</h2></th></tr>
<tr><td><br><input type="text" title="Ejemplo: 2M26123123" name="NoSerie" form="registrotec" class="inputl" id="NoSerie"
required placeholder="N&uacute;mero de serie" pattern="2[mM]{1}2[a-zA-Z0-9]{7}" maxlength="10"></td></tr>


<td ><br><button name="Registrar" form="registrotec" style="width:400px;" class="btn1" id="Registrar"
onclick="Validar(document.getElementById('NoSerie').value);">Buscar</button></td></tr>
