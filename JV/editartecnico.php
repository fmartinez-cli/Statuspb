...
<center>
					<div class="grupo">
						<div class="caja">
							...
							echo '<div class="editartec"><h2 style="color:#CC263A;">Editar t&eacute;cnico</h2>';
							while ($datos=mysqli_fetch_row($query) ) {
								...
								<button class="btn1" style="width:800px; text-align:center;"><b>Nombre: <b>'.$datos["2"].'<b>  &nbsp;&nbsp;&nbsp;  <b>No. Reloj:</b> '.$datos["0"].' &nbsp;&nbsp;&nbsp;  <b>Turno:</b> '.$datos["3"].'  &nbsp;&nbsp;&nbsp;  <b>Bahia:</b> '.$datos["5"].'</button>
								</form>
								</div>
								...
								<form name="buscartec" action="return false" onsubmit="return false" method="post">
									<br><input class="inputl" required type="text" name="NoReloj" id="NoReloj" placeholder="N&uacute;mero de reloj" maxlength="5" pattern="[0-9]{5}">
									<br><br><button class="btn1" onclick="Validar(document.getElementById('NoReloj').value);">Buscar</button>
								</form>
