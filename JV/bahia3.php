          ...
          <center>
            <nav>
              <ul class="topnav">
                ...
                <li><a style="color:#CC263A; font-weight:bold;" class="hvr-underline-from-center" href="bahia3.php"><img width="10" src="../img/bay.png"> Bahia 3</a></li>
            ...
            <div class="grupo">
              <div class="caja ">
                <center>
                  <table>
                    <tr>
                      <td  id="open1" class="_<?php echo ($contr1['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr1['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"> <a  id="popup1" class="link1" href="modales.php?pb=<?php echo "$NoSerie1"; ?>&tr=TR03-17" rel="moodalbox" ><div class="link"> TR03-17 <hr> <br><?php echo $Prueba1; echo "</br>".$NoSerie1; ?></div></a></td>
                      <td  id="open2" class="_<?php echo ($contr2['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr2['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"> <a  id="popup2" class="link1" href="modales.php?pb=<?php echo "$NoSerie2"; ?>&tr=TR03-18" rel="moodalbox" ><div class="link">TR03-18 <hr><br> <?php echo $Prueba2; echo "</br>".$NoSerie2; ?></div></a></td>
                      <td  id="open3" class="_<?php echo ($contr3['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr3['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"><a  id="popup3" class="link1" href="modales.php?pb=<?php echo "$NoSerie3"; ?>&tr=TR03-19" rel="moodalbox" > <div class="link">TR03-19 <hr> <br><?php echo $Prueba3; echo "</br>".$NoSerie3; ?></div></a></td>
                      <td  id="open4" class="_<?php echo ($contr4['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr4['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"> <a  id="popup4" class="link1" href="modales.php?pb=<?php echo "$NoSerie4"; ?>&tr=TR03-20" rel="moodalbox" ><div class="link">TR03-20 <hr> <br><?php echo $Prueba4; echo "</br>".$NoSerie4; ?></div></a></td>
                      <td  id="open5"  class="_<?php echo ($contr5['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr5['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center">  <a  id="popup5" class="link1" href="modales.php?pb=<?php echo "$NoSerie5"; ?>&tr=TR03-21" rel="moodalbox" > <div class="link">TR03-21 <hr><br> <?php echo $Prueba5; echo "</br>".$NoSerie5; ?></div></a></td>
                      <td  id="open6" class="_<?php echo ($contr6['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr6['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center">  <a  id="popup6" class="link1" href="modales.php?pb=<?php echo "$NoSerie6"; ?>&tr=TR03-22" rel="moodalbox" > <div class="link">TR03-22 <hr> <br><?php echo $Prueba6; echo "</br>".$NoSerie6; ?></div></a></td>
                      <td  id="open7" class="_<?php echo ($contr7['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr7['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center" > <a  id="popup7" class="link1" href="modales.php?pb=<?php echo "$NoSerie7"; ?>&tr=TR03-23" rel="moodalbox" >  <div class="link">TR03-23 <hr><br> <?php echo $Prueba7; echo "</br>".$NoSerie7; ?></div></a></td>
                      <td  id="open8" class="_<?php echo ($contr8['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr8['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center">  <a  id="popup8" class="link1" href="modales.php?pb=<?php echo "$NoSerie8"; ?>&tr=TR03-24" rel="moodalbox" > <div class="link">TR03-24 <hr><br> <?php echo $Prueba8; echo "</br>".$NoSerie8; ?></div></a></td>
                    </tr>
                  </table>
                </center>
              </div>
          ...
          <section>
            <div class="grupo">
              ...
              $query0 = mysqli_query($enlace, "SELECT racksjv.NoSerie, racksjv.Modelo FROM racksjv INNER JOIN pruebasjv on
                pruebasjv.NoSerie=racksjv.NoSerie WHERE Bahia = '3' AND Modelo='Microsoft' AND area='JV'");
                $query = mysqli_query($enlace, "SELECT racksjv.Locacion, racksjv.NoSerie, racksjv.WO, racksjv.SKU,
                  ...
                  WHERE Bahia='3' AND Modelo = 'Microsoft' AND area='JV'
