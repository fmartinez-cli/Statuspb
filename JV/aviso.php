...
<section>
 ...
 word-wrap: break-word;''><h3>".$comentario."</h3></p><br><p style='font-weight:bold; color:#3e3e3e;	text-align:right;'>Publicado por: ". $datos[1]. "<br>Fecha: ".$datos[5]."</p></div>";
				}
				//  <!-- ******************comentarios************************ -->
		 	 ...
		 	 while ($datos=mysqli_fetch_row($query) ) {
		 		 ...
		 		 word-wrap: break-word; font-size:20px;">'.$comentario.'</p>
		 		 </div></div><br></center>';}
		 		 ?>
		 	 </div>
		 				 </div>
