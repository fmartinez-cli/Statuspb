<?php 
							...
							if ($datos=mysqli_fetch_row($query2) ) {
								...
								';
									...
									echo "<span style='color:white; background:#D91E18; margin-top:480px; padding:10px; width:500px; '>No se encontro el n&uacute;mero de reloj</span>";
								}
								
							}else{
								echo "<span style='color:white; background:#D91E18; margin-top:480px; padding:10px; width:500px; '>Ingrese un n&uacute;mero de reloj v&aacute;lido</span>";
							}}
								?>