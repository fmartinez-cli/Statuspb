...
function Validate(oForm) {
    ...
    for (var i = 0; i < arrInputs.length; i++) {
        ...
        if (oInput.type == "file") {
            ...
            if (sFileName.length > 0) {
                ...
                if (!blnValid) {
                    alert( + sFileName + " El formato del archivo no es valido, formatos permitidos: " + _validFileExtensions.join(", "));
                    return false;
                }
            }
        }
	...
	<body class="desarroll">
		...
		<!-- ********************LOGIN***********************************-->
				...
				<section>
<center>
	<h1 style="font-size:4em; color:#3e3e3e;">EN CONSTRUCCION</h1>
					<div class="grupo">
						<div class="caja">
<table class="tablaadminjv">
<tr><th colspan="3">T&eacute;cnicos</th></tr>
<tr><td><a href="registrartecnico.php">Agregar</a></td><td><a href="editartecnico.php">Editar</a></td><td><a href="borrartecnico.php">Eliminar</a></td></tr>
</table>

<table class="tablaadminjv">
<tr><th colspan="3">Racks</th></tr>
<tr><td><a href="editarrack.php">Editar</a></td><td><a href="retrocederrack.php">Retroceder</a></td><td><a href="borrarrack.php">Eliminar</a></td></tr>
</table>
    ...
    <div class="grupo">
		...
		<div class="foto">
		<center>
		<div id="titulojv"><h1>Subir Aviso</h1></div><br>
		<form action="Raviso.php" method="post" enctype="multipart/form-data" onsubmit="return Validate(this);">
			<input type="file" name="imagen">
			<br /><br/>
			<input class="inputl" type="text" name="titulo" placeholder="Titulo" maxlength="35" required><br><br>
