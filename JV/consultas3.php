...
include("conexion.php");
					...
					$constr1=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-17' AND area='JV'"); if($contr1=mysqli_fetch_array($constr1)){ $NoSerie1=$contr1['NoSerie']; }else{ $NoSerie1="Disponible"; }
					$constr2=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-18' AND area='JV'"); if($contr2=mysqli_fetch_array($constr2)){ $NoSerie2=$contr2['NoSerie']; }else{ $NoSerie2="Disponible"; }
					$constr3=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-19' AND area='JV'"); if($contr3=mysqli_fetch_array($constr3)){ $NoSerie3=$contr3['NoSerie']; }else{ $NoSerie3="Disponible"; }
					$constr4=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-20' AND area='JV'"); if($contr4=mysqli_fetch_array($constr4)){ $NoSerie4=$contr4['NoSerie']; }else{ $NoSerie4="Disponible"; }
					$constr5=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-21' AND area='JV'"); if($contr5=mysqli_fetch_array($constr5)){ $NoSerie5=$contr5['NoSerie']; }else{ $NoSerie5="Disponible"; }
					$constr6=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-22' AND area='JV'"); if($contr6=mysqli_fetch_array($constr6)){ $NoSerie6=$contr6['NoSerie']; }else{ $NoSerie6="Disponible"; }
					$constr7=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-23' AND area='JV'"); if($contr7=mysqli_fetch_array($constr7)){ $NoSerie7=$contr7['NoSerie']; }else{ $NoSerie7="Disponible"; }
					$constr8=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR03-24' AND area='JV'"); if($contr8=mysqli_fetch_array($constr8)){ $NoSerie8=$contr8['NoSerie']; }else{ $NoSerie8="Disponible"; }
