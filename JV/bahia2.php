      ...
      <div class="grupo total">
        <div class="caja">
          <center>
            <nav>
              <ul class="topnav">
                <li id="open8" ><a class="hvr-underline-from-center" href="index.php"><img width="15" src="../img/home.png"> Inicio</a></li>
                <li style=""><a  class="hvr-underline-from-center" href="bahia1.php"><img width="10" src="../img/bay.png"> Bahia 1</a></li>
                <li><a style="color:#CC263A; font-weight:bold;" class="hvr-underline-from-center" href="bahia2.php"><img width="10" src="../img/bay.png"> Bahia 2</a></li>
        ...
        <section>
            ...
            <div class="grupo">
              <div class="caja ">
                <center>
                  <table>
                    <tr>
                      <td id="open1" class="_<?php echo ($contr1['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr1['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"> <a  id="popup1" class="link1" href="modales.php?pb=<?php echo "$NoSerie1"; ?>&tr=TR02-09" rel="moodalbox" ><div class="link"> TR02-09 <hr> <br><?php echo $Prueba1; echo "</br>".$NoSerie1; ?></div></a></td>
                      <td id="open2" class="_<?php echo ($contr2['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr2['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"> <a id="popup2"  class="link1" href="modales.php?pb=<?php echo "$NoSerie2"; ?>&tr=TR02-10" rel="moodalbox" ><div class="link">TR02-10 <hr><br> <?php echo $Prueba2; echo "</br>".$NoSerie2; ?></div></a></td>
                      <td id="open3" class="_<?php echo ($contr3['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr3['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"><a  id="popup3" class="link1" href="modales.php?pb=<?php echo "$NoSerie3"; ?>&tr=TR02-11" rel="moodalbox" > <div class="link">TR02-11 <hr> <br><?php echo $Prueba3; echo "</br>".$NoSerie3; ?></div></a></td>
                      <td id="open4" class="_<?php echo ($contr4['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr4['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center"> <a  id="popup4" class="link1" href="modales.php?pb=<?php echo "$NoSerie4"; ?>&tr=TR02-12" rel="moodalbox" ><div class="link">TR02-12 <hr> <br><?php echo $Prueba4; echo "</br>".$NoSerie4; ?></div></a></td>
                      <td id="open5" class="_<?php echo ($contr5['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr5['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center">  <a  id="popup5" class="link1" href="modales.php?pb=<?php echo "$NoSerie5"; ?>&tr=TR02-13" rel="moodalbox" > <div class="link">TR02-13 <hr><br> <?php echo $Prueba5; echo "</br>".$NoSerie5; ?></div></a></td>
                      <td id="open8" class="_<?php echo ($contr6['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr6['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center">  <a id="popup6"  class="link1" href="modales.php?pb=<?php echo "$NoSerie6"; ?>&tr=TR02-14" rel="moodalbox" > <div class="link">TR02-14 <hr> <br><?php echo $Prueba6; echo "</br>".$NoSerie6; ?></div></a></td>
                      <td id="open7" class="_<?php echo ($contr7['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr7['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center" > <a id="popup7"  class="link1" href="modales.php?pb=<?php echo "$NoSerie7"; ?>&tr=TR02-15" rel="moodalbox" >  <div class="link">TR02-15 <hr><br> <?php echo $Prueba7; echo "</br>".$NoSerie7; ?></div></a></td>
                      <td id="open8" class="_<?php echo ($contr8['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr8['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3')) ;?> hvr-bob hvr-underline-from-center">  <a id="popup8"  class="link1" href="modales.php?pb=<?php echo "$NoSerie8"; ?>&tr=TR02-16" rel="moodalbox" > <div class="link">TR02-16 <hr><br> <?php echo $Prueba8; echo "</br>".$NoSerie8; ?></div></a></td>
                    </tr>
                  </table>
                </center>
              </div>
          ...
          <section>
            <div class="grupo">
              ...
              pruebasjv.NoSerie=racksjv.NoSerie WHERE Bahia = '2' AND Modelo='Microsoft' AND area='JV'");
              ...
              WHERE Bahia='2' AND Modelo = 'Microsoft' AND area='JV'
