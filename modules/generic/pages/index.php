                    ...
                    <div class="bay-grid">
                        <?php for($line = 1; $line <= 5; $line++): ?>
                            <?php for($bay = 1; $bay <= 2; $bay++): 
                                ...
                                if($bay_num <= 10):
                            ?>
                            <a href="bay<?php echo $bay_num; ?>.php" class="bay-card">
                        ...
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="modals.php?pb=<?php echo urlencode($rack['serial_number']); ?>" class="text-decoration-none">
...
<!-- Manual link -->
<a href="manual.php" class="manual-link" title="User Manual" style="position:fixed; bottom:20px; left:20px; z-index:9999;">
