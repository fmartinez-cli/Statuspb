		...
		<div class="caja">
			<nav>
				<center>	<ul class="topnav">
						...
						<li><a style="color:#59ABE3; font-weight:bold;" class="hvr-underline-from-center" href="bahia6.php"><img width="10" src="../img/bay.png"> Bahia 6</a></li>
...
<div id="popup" style="display: none;">
    <div class="content-popup">
        ...
        <div>
           <center><h2>Gbics registrados: Bahía 6</h2>
           <br>
           <?php
           $NoBahia='6';
...
<section>
				...
				<center> -->
					<table>
						...
						<tr>
							...
							<td id="open1" class="_<?php echo ($contr1['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr1['Modelo'] == 'Dropbox' ? 'trs2' : ($contr1['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup1" class="link1" href="modales.php?pb=<?php echo "$NoSerie1"; ?>&tr=TR06-81" rel="moodalbox" ><div class="link"> TR06-81 <hr> <br><?php echo $Prueba1; echo "</br>".$NoSerie1; ?></div></a></td>
							<td id="open2" class="_<?php echo ($contr2['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr2['Modelo'] == 'Dropbox' ? 'trs2' : ($contr2['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup2" class="link1" href="modales.php?pb=<?php echo "$NoSerie2"; ?>&tr=TR06-82" rel="moodalbox" ><div class="link">TR06-82 <hr> <br><?php echo $Prueba2; echo "</br>".$NoSerie2; ?></div></a></td>
							<td id="open3" class="_<?php echo ($contr3['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr3['Modelo'] == 'Dropbox' ? 'trs2' : ($contr3['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"><a id="popup3" class="link1" href="modales.php?pb=<?php echo "$NoSerie3"; ?>&tr=TR06-83" rel="moodalbox" > <div class="link">TR06-83 <hr> <br><?php echo $Prueba3; echo "</br>".$NoSerie3; ?></div></a></td>
							<td id="open4" class="_<?php echo ($contr4['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr4['Modelo'] == 'Dropbox' ? 'trs2' : ($contr4['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup4" class="link1" href="modales.php?pb=<?php echo "$NoSerie4"; ?>&tr=TR06-84" rel="moodalbox" ><div class="link">TR06-84 <hr> <br><?php echo $Prueba4; echo "</br>".$NoSerie4; ?></div></a></td>
							<td id="open5" class="_<?php echo ($contr5['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr5['Modelo'] == 'Dropbox' ? 'trs2' : ($contr5['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center">  <a id="popup5" class="link1" href="modales.php?pb=<?php echo "$NoSerie5"; ?>&tr=TR06-85" rel="moodalbox" > <div class="link">TR06-85 <hr> <br><?php echo $Prueba5; echo "</br>".$NoSerie5; ?></div></a></td>
							<td id="open6" class="_<?php echo ($contr6['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr6['Modelo'] == 'Dropbox' ? 'trs2' : ($contr6['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center">  <a id="popup6" class="link1" href="modales.php?pb=<?php echo "$NoSerie6"; ?>&tr=TR06-86" rel="moodalbox" > <div class="link">TR06-86 <hr> <br><?php echo $Prueba6; echo "</br>".$NoSerie6; ?></div></a></td>
							<td id="open7" class="_<?php echo ($contr7['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr7['Modelo'] == 'Dropbox' ? 'trs2' : ($contr7['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center" > <a id="popup7" class="link1" href="modales.php?pb=<?php echo "$NoSerie7"; ?>&tr=TR06-87" rel="moodalbox" >  <div class="link">TR06-87 <hr> <br><?php echo $Prueba7; echo "</br>".$NoSerie7; ?></div></a></td>
							<td id="open8" class="_<?php echo ($contr8['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr8['Modelo'] == 'Dropbox' ? 'trs2' : ($contr8['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center" > <a id="popup7" class="link1" href="modales.php?pb=<?php echo "$NoSerie8"; ?>&tr=TR06-88" rel="moodalbox" >  <div class="link">TR06-88 <hr> <br><?php echo $Prueba8; echo "</br>".$NoSerie8; ?></div></a></td>
							<td id="open9" class="_<?php echo ($contr9['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr9['Modelo'] == 'Dropbox' ? 'trs2' : ($contr9['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center" > <a id="popup7" class="link1" href="modales.php?pb=<?php echo "$NoSerie9"; ?>&tr=TR06-89" rel="moodalbox" >  <div class="link">TR06-89 <hr> <br><?php echo $Prueba9; echo "</br>".$NoSerie9; ?></div></a></td>
							<td id="open10" class="_<?php echo ($contr10['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr10['Modelo'] == 'Dropbox' ? 'trs2' : ($contr10['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center" hvr-bob hvr-underline-from-center>  <a id="popup8" class="link1" href="modales.php?pb=<?php echo "$NoSerie10"; ?>&tr=TR06-90" rel="moodalbox" > <div class="link">TR06-90 <hr> <br><?php echo $Prueba10; echo "</br>".$NoSerie10; ?>
						
						</div></a></td>
						</tr>

						<tr>
						    <td id="open20" class="_<?php echo ($contr20['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr20['Modelo'] == 'Dropbox' ? 'trs2' : ($contr20['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup20" class="link1" href="modales.php?pb=<?php echo "$NoSerie20"; ?>&tr=TR06-100" rel="moodalbox" ><div class="link"> TR06-100 <hr> <br><?php echo $Prueba20; echo "</br>".$NoSerie20; ?></div></a></td>
						    <td id="open19" class="_<?php echo ($contr19['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr19['Modelo'] == 'Dropbox' ? 'trs2' : ($contr19['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup19" class="link1" href="modales.php?pb=<?php echo "$NoSerie19"; ?>&tr=TR06-99" rel="moodalbox" ><div class="link"> TR06-99 <hr> <br><?php echo $Prueba19; echo "</br>".$NoSerie19; ?></div></a></td>
							<td id="open18" class="_<?php echo ($contr18['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr18['Modelo'] == 'Dropbox' ? 'trs2' : ($contr18['Modelo'] == 'Microsoft' ? 'trs4' :  'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup18" class="link1" href="modales.php?pb=<?php echo "$NoSerie18"; ?>&tr=TR06-98" rel="moodalbox" ><div class="link"> TR06-98 <hr> <br><?php echo $Prueba18; echo "</br>".$NoSerie18; ?></div></a></td>
							<td id="open17" class="_<?php echo ($contr17['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr17['Modelo'] == 'Dropbox' ? 'trs2' : ($contr17['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3')));?> hvr-bob hvr-underline-from-center"> <a id="popup17" class="link1" href="modales.php?pb=<?php echo "$NoSerie17"; ?>&tr=TR06-97" rel="moodalbox" ><div class="link"> TR06-97 <hr> <br><?php echo $Prueba17; echo "</br>".$NoSerie17; ?></div></a></td>
							<td id="open16" class="_<?php echo ($contr16['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr16['Modelo'] == 'Dropbox' ? 'trs2' : ($contr16['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup16" class="link1" href="modales.php?pb=<?php echo "$NoSerie16"; ?>&tr=TR06-96" rel="moodalbox" ><div class="link"> TR06-96 <hr> <br><?php echo $Prueba16; echo "</br>".$NoSerie16; ?></div></a></td>
							<td id="open15" class="_<?php echo ($contr15['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr15['Modelo'] == 'Dropbox' ? 'trs2' : ($contr15['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup15" class="link1" href="modales.php?pb=<?php echo "$NoSerie15"; ?>&tr=TR06-95" rel="moodalbox" ><div class="link"> TR06-95 <hr> <br><?php echo $Prueba15; echo "</br>".$NoSerie15; ?></div></a></td>
							<td id="open14" class="_<?php echo ($contr14['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr14['Modelo'] == 'Dropbox' ? 'trs2' : ($contr14['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup14" class="link1" href="modales.php?pb=<?php echo "$NoSerie14"; ?>&tr=TR06-94" rel="moodalbox" ><div class="link"> TR06-94 <hr> <br><?php echo $Prueba14; echo "</br>".$NoSerie14; ?></div></a></td>
							<td id="open13" class="_<?php echo ($contr13['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr13['Modelo'] == 'Dropbox' ? 'trs2' : ($contr13['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup13" class="link1" href="modales.php?pb=<?php echo "$NoSerie13"; ?>&tr=TR06-93" rel="moodalbox" ><div class="link"> TR06-93 <hr> <br><?php echo $Prueba13; echo "</br>".$NoSerie13; ?></div></a></td>
							<td id="open12" class="_<?php echo ($contr12['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr12['Modelo'] == 'Dropbox' ? 'trs2' : ($contr12['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup12" class="link1" href="modales.php?pb=<?php echo "$NoSerie12"; ?>&tr=TR06-92" rel="moodalbox" ><div class="link"> TR06-92 <hr> <br><?php echo $Prueba12; echo "</br>".$NoSerie12; ?></div></a></td>
							<td id="open11" class="_<?php echo ($contr11['Modelo'] == 'Azure 4.1' ? 'trs' :  ($contr11['Modelo'] == 'Dropbox' ? 'trs2' : ($contr11['Modelo'] == 'Microsoft' ? 'trs4' :   'trs3'))) ;?> hvr-bob hvr-underline-from-center"> <a id="popup11" class="link1" href="modales.php?pb=<?php echo "$NoSerie11"; ?>&tr=TR06-91" rel="moodalbox" ><div class="link"> TR06-91 <hr> <br><?php echo $Prueba11; echo "</br>".$NoSerie11; ?></div></a></td>
						</tr>
	...
	<section>
		<div class="grupo">
				...
				$query0 = mysqli_query($enlace, "SELECT racks.NoSerie, racks.Modelo FROM racks INNER JOIN pruebas on
					pruebas.NoSerie=racks.NoSerie WHERE Bahia = '6'  AND Modelo='Azure 4.1'");
				$query = mysqli_query($enlace, "SELECT racks.Locacion, racks.NoSerie, racks.WO, racks.SKU,
					...
					WHERE Bahia='6' AND Modelo = 'Azure 4.1'
				...
				if($datos0=mysqli_fetch_row($query0)){
					...
					<table width='100%' class='tablaST'>
						<caption style='background-color:#3e3e3e; color:white; padding:10px;'><h1 style='color:white;'>Azure 4.1</h1></caption>
				...
				$query2 = mysqli_query($enlace, "SELECT racks.NoSerie, racks.Modelo FROM racks INNER JOIN pruebas on
					pruebas.NoSerie=racks.NoSerie WHERE Bahia = '6' AND Modelo='Dropbox'");
				...
				$query3 = mysqli_query($enlace, "SELECT racks.Locacion, racks.NoSerie, racks.WO, racks.SKU,
					...
					FROM racks
					INNER JOIN pruebas on pruebas.NoSerie=racks.NoSerie
					WHERE Bahia='6' AND Modelo = 'Dropbox'
					ORDER BY Locacion ASC");

				if($datos2=mysqli_fetch_row($query2)){
					echo "  <div class='caja'>
					<table width='100%' class='tablaST'>
					<caption style='background-color:#3e3e3e; color:white; padding:10px;'><h1>Dropbox</h1></caption>
	...
	<section>
            <div class="grupo">
              ...
              pruebasjv.NoSerie=racksjv.NoSerie WHERE Bahia = '6' AND Modelo='Microsoft' AND area='LVO'");
              ...
              WHERE Bahia='6' AND Modelo = 'Microsoft' AND area='LVO'
              ORDER BY Locacion ASC");
              if($datos0=mysqli_fetch_row($query0)){
                echo " <div class='caja'>
                <table width='100%' style='opacity:.9;' class='tablaST'>
                <caption style='background-color:#3e3e3e; color:white; padding:10px;'><h1>Microsoft</h1></caption>
