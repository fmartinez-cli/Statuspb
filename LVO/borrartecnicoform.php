...
if (!isset($_SESSION['Nombre'])){
	...
	if($_SESSION['Nivel']!='1'){
		...
		<html>
		<head>
			<title>Eliminar t&eacute;cnico</title>
...
<script>
	...
	{
		$.ajax({
			url: "borrartecnicoformbackend.php",
			type: "POST",
	...
	<body class="desarroll">
        ...
        <?php if(isset($_SESSION['Nombre'])){
						echo '<section>
						<center><div class="nombre"> <p class="info" title="">'.$_SESSION["Nombre"].'<span>Número de reloj: '.$_SESSION["No_Reloj"].' <br> '.$_SESSION['Turno'].'&deg; Turno</span></p></div></center>			</section>	';
					} ?>
					<!-- ********************LOGIN***********************************-->
		<?php
...
<tr><th><h2>Eliminar t&eacute;cnico</h2></th></tr>
<tr><td>
	<input type="hidden" disabled name="oldnoreloj" id="oldnoreloj" value="<?php echo $NoReloj; ?>" form="registrotec">
	<input type="text" disabled title="N&uacute;mero de reloj" value="<?php echo $NoReloj; ?>" name="NoReloj" form="registrotec" class="inputl" id="NoReloj" required placeholder="N&uacute;mero de reloj" pattern="[0-9]{5}" maxlength="5"></td></tr>
<tr><td><input type="text" disabled title="Nombre" value="<?php echo $Nombre; ?>" name="Nombre" form="registrotec" class="inputl" id="Nombre" required placeholder="Nombre" pattern="[a-zA-Z\ñ\Ñ\ ]{1,}" maxlength="30"></td></tr>
<tr><td><input type="password" title="Contrase&ntilde;a" disabled name="Pass" form="registrotec" value="<?php echo $Pass; ?>" class="inputl" id="Pass" required placeholder="Contrase&ntilde;a"  maxlength="15"></td></tr>
<tr><td><input type="password" title="Contrase&ntilde;a" disabled name="Pass2" form="registrotec" value="<?php echo $Pass; ?>" class="inputl" id="Pass2" required placeholder="Confirmar contrase&ntilde;a"  maxlength="15"></td></tr>
<tr><td><select class="inputl" title="Turno" disabled name="Turno" id="Turno" form="registrotec" required>
<option value="<?php echo $Turno; ?>">Turno: <?php echo $Turno; ?></option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
</select>
<tr><td><select class="inputl" title="Bahia" disabled name="Bahia" id="Bahia" form="registrotec" required>
...
document.getElementById('Pass2').value, document.getElementById('Turno').value, document.getElementById('Bahia').value, document.getElementById('oldnoreloj').value);">Eliminar</button></td></tr>
