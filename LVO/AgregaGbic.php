...
<script>
	function Validar(ctgbic, Bahia)
	{
		$.ajax({
			url: "AgregaGbicBackend.php",
			type: "POST",
			data: "ctgbic="+ctgbic+"&Bahia="+Bahia,
...
<center>
					<div class="grupo">
						<div class="caja">
							<form id="registrogbic" name="registrogbic" method="POST" action="return false" onsubmit="return false">
<table class="formsadmin">
<tr><th><h2>Agregar Gbic</h2></th></tr>
<tr><td><br><input type="text" title="Ct Gbic" name="ctgbic" form="registrogbic" class="inputl" id="ctgbic" required placeholder="Ct Gbic" minlength="8" maxlength="12"></td></tr>

<tr><td><select class="inputl" name="Bahia" id="Bahia" form="registrogbic" required>
...
<td ><button name="Registrar" form="registrogbic" style="width:400px;" class="btn1" id="Registrar"
onclick="Validar(document.getElementById('ctgbic').value, document.getElementById('Bahia').value);">Registrar</button></td></tr>
