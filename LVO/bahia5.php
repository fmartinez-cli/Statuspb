		...
		<div class="caja">
			<nav>
				<center>	<ul class="topnav">
						...
						<li><a style="color:#59ABE3; font-weight:bold;" class="hvr-underline-from-center" href="bahia5.php"><img width="10" src="../img/bay.png"> Bahia 5</a></li>
...
<div id="popup" style="display: none;">
    <div class="content-popup">
        ...
        <div>
           <center><h2>Gbics registrados: Bahía 5</h2>
           <br>
           <?php
           $NoBahia='5';
	...
	<section>
		<div class="grupo">
				...
				$query0 = mysqli_query($enlace, "SELECT racks.NoSerie, racks.Modelo FROM racks INNER JOIN pruebas on
					pruebas.NoSerie=racks.NoSerie WHERE Bahia = '5' AND Modelo='Azure 4.1'");
				$query = mysqli_query($enlace, "SELECT racks.Locacion, racks.NoSerie, racks.WO, racks.SKU,
					...
					WHERE Bahia='5' AND Modelo = 'Azure 4.1'
				...
				$query2 = mysqli_query($enlace, "SELECT racks.NoSerie, racks.Modelo FROM racks INNER JOIN pruebas on
					pruebas.NoSerie=racks.NoSerie WHERE Bahia = '5' AND Modelo='Dropbox'");
				...
				$query3 = mysqli_query($enlace, "SELECT racks.Locacion, racks.NoSerie, racks.WO, racks.SKU,
					...
					FROM racks
					INNER JOIN pruebas on pruebas.NoSerie=racks.NoSerie
					WHERE Bahia='5' AND Modelo = 'Dropbox'
					ORDER BY Locacion ASC");
...
<!-- status bahia JV -->
  <section>
            <div class="grupo">
              ...
              pruebasjv.NoSerie=racksjv.NoSerie WHERE Bahia = '5' AND Modelo='Microsoft' AND area='LVO'");
              ...
              WHERE Bahia='5' AND Modelo = 'Microsoft' AND area='LVO'
              ORDER BY Locacion ASC");
              if($datos0=mysqli_fetch_row($query0)){
                echo " <div class='caja'>
