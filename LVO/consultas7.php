...
include("conexion.php");
	...
	$constr1=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-97'"); if($contr1=mysqli_fetch_array($constr1)){ $NoSerie1=$contr1['NoSerie']; }
	else{ $constr1=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-97' AND area='LVO'"); 
	if($contr1=mysqli_fetch_array($constr1)){ $NoSerie1=$contr1['NoSerie']; }else{ $NoSerie1="Disponible"; } }
	$constr2=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-98'"); if($contr2=mysqli_fetch_array($constr2)){ $NoSerie2=$contr2['NoSerie']; }
	else{ $constr2=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-98' AND area='LVO'"); 
	if($contr2=mysqli_fetch_array($constr2)){ $NoSerie2=$contr2['NoSerie']; }else{ $NoSerie2="Disponible"; } }
	$constr3=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-99'"); if($contr3=mysqli_fetch_array($constr3)){ $NoSerie3=$contr3['NoSerie']; }
	else{ $constr3=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-99' AND area='LVO'"); 
	if($contr3=mysqli_fetch_array($constr3)){ $NoSerie3=$contr3['NoSerie']; }else{ $NoSerie3="Disponible"; } }
	$constr4=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-100'"); if($contr4=mysqli_fetch_array($constr4)){ $NoSerie4=$contr4['NoSerie']; }
	else{ $constr4=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-100' AND area='LVO'"); 
	if($contr4=mysqli_fetch_array($constr4)){ $NoSerie4=$contr4['NoSerie']; }else{ $NoSerie4="Disponible"; } }
	$constr5=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-101'"); if($contr5=mysqli_fetch_array($constr5)){ $NoSerie5=$contr5['NoSerie']; }
	else{ $constr5=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-101' AND area='LVO'"); 
	if($contr5=mysqli_fetch_array($constr5)){ $NoSerie5=$contr5['NoSerie']; }else{ $NoSerie5="Disponible"; } }
	$constr6=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-102'"); if($contr6=mysqli_fetch_array($constr6)){ $NoSerie6=$contr6['NoSerie']; }
	else{ $constr6=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-102' AND area='LVO'"); 
	if($contr6=mysqli_fetch_array($constr6)){ $NoSerie6=$contr6['NoSerie']; }else{ $NoSerie6="Disponible"; } }
	$constr7=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-103'"); if($contr7=mysqli_fetch_array($constr7)){ $NoSerie7=$contr7['NoSerie']; }
	else{ $constr7=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-103' AND area='LVO'"); 
	if($contr7=mysqli_fetch_array($constr7)){ $NoSerie7=$contr7['NoSerie']; }else{ $NoSerie7="Disponible"; } }
	$constr8=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-104'"); if($contr8=mysqli_fetch_array($constr8)){ $NoSerie8=$contr8['NoSerie']; }
	else{ $constr8=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-104' AND area='LVO'"); 
	if($contr8=mysqli_fetch_array($constr8)){ $NoSerie8=$contr8['NoSerie']; }else{ $NoSerie8="Disponible"; } }
	$constr9=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-105'"); if($contr9=mysqli_fetch_array($constr9)){ $NoSerie9=$contr9['NoSerie']; }
	else{ $constr9=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-105' AND area='LVO'"); 
	if($contr9=mysqli_fetch_array($constr9)){ $NoSerie9=$contr9['NoSerie']; }else{ $NoSerie9="Disponible"; } }
	$constr10=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-106'"); if($contr10=mysqli_fetch_array($constr10)){ $NoSerie10=$contr10['NoSerie']; }
	else{ $constr10=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-106' AND area='LVO'"); 
	if($contr10=mysqli_fetch_array($constr10)){ $NoSerie10=$contr10['NoSerie']; }else{ $NoSerie10="Disponible"; } }
	$constr11=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-107'"); if($contr11=mysqli_fetch_array($constr11)){ $NoSerie11=$contr11['NoSerie']; }
	else{ $constr11=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-107' AND area='LVO'"); 
	if($contr11=mysqli_fetch_array($constr11)){ $NoSerie11=$contr11['NoSerie']; }else{ $NoSerie11="Disponible"; } }
	$constr12=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-108'"); if($contr12=mysqli_fetch_array($constr12)){ $NoSerie12=$contr12['NoSerie']; }
	else{ $constr12=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-108' AND area='LVO'"); 
	if($contr12=mysqli_fetch_array($constr12)){ $NoSerie12=$contr12['NoSerie']; }else{ $NoSerie12="Disponible"; } }
	$constr13=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-109'"); if($contr13=mysqli_fetch_array($constr13)){ $NoSerie13=$contr13['NoSerie']; }
	else{ $constr13=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-109' AND area='LVO'"); 
	if($contr13=mysqli_fetch_array($constr13)){ $NoSerie13=$contr13['NoSerie']; }else{ $NoSerie13="Disponible"; } }
	$constr14=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-110'"); if($contr14=mysqli_fetch_array($constr14)){ $NoSerie14=$contr14['NoSerie']; }
	else{ $constr14=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-110' AND area='LVO'"); 
	if($contr14=mysqli_fetch_array($constr14)){ $NoSerie14=$contr14['NoSerie']; }else{ $NoSerie14="Disponible"; } }
	$constr15=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-111'"); if($contr15=mysqli_fetch_array($constr15)){ $NoSerie15=$contr15['NoSerie']; }
	else{ $constr15=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-111' AND area='LVO'"); 
	if($contr15=mysqli_fetch_array($constr15)){ $NoSerie15=$contr15['NoSerie']; }else{ $NoSerie15="Disponible"; } }
	$constr16=mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR07-112'"); if($contr16=mysqli_fetch_array($constr16)){ $NoSerie16=$contr16['NoSerie']; }
	else{ $constr16=mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR07-112' AND area='LVO'"); 
