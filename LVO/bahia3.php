		...
		<div class="caja">
			<nav>
				<center>	<ul class="topnav">
						...
						<li><a style="color:#59ABE3; font-weight:bold;" class="hvr-underline-from-center" href="bahia3.php"><img width="10" src="../img/bay.png"> Bahia 3</a></li>
...
<div id="popup" style="display: none;">
    <div class="content-popup">
        ...
        <div>
           <center><h2>Gbics registrados: Bahía 3</h2>
           <br>
           <?php
           $NoBahia='3';
...
<!-- fin de nuevo div de gbics -->
	...
	<section>
		<div class="grupo">
				...
				$query0 = mysqli_query($enlace, "SELECT racks.NoSerie, racks.Modelo FROM racks INNER JOIN pruebas on
					pruebas.NoSerie=racks.NoSerie WHERE Bahia = '3' AND Modelo='Azure 4.1'");
				$query = mysqli_query($enlace, "SELECT racks.Locacion, racks.NoSerie, racks.WO, racks.SKU,
					...
					WHERE Bahia='3' AND Modelo = 'Azure 4.1'
				...
				$query2 = mysqli_query($enlace, "SELECT racks.NoSerie, racks.Modelo FROM racks INNER JOIN pruebas on
					pruebas.NoSerie=racks.NoSerie WHERE Bahia = '3' AND Modelo='Dropbox'");
				...
				$query3 = mysqli_query($enlace, "SELECT racks.Locacion, racks.NoSerie, racks.WO, racks.SKU,
					...
					FROM racks
					INNER JOIN pruebas on pruebas.NoSerie=racks.NoSerie
					WHERE Bahia='3' AND Modelo = 'Dropbox'
					ORDER BY Locacion ASC");
	...
	<section>
						<div class="grupo">
							...
							pruebasjv.NoSerie=racksjv.NoSerie WHERE Bahia = '3' AND Modelo='Microsoft' AND area='LVO'");
							...
							WHERE Bahia='3' AND Modelo = 'Microsoft' AND area='LVO'
							ORDER BY Locacion ASC");
							if($datos0=mysqli_fetch_row($query0)){
								echo " <div class='caja'>
