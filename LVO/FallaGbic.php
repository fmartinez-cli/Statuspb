...
if (!isset($_SESSION['Nombre'])){
	...
	if($_SESSION['Nivel']!='1'){
		...
		<html>
		<head>
			<title>Reportar falla Gbic</title>
...
<script>
	function Validar(ctgbic)
	{
		$.ajax({
			url: "FallaGbicBackend.php",
			type: "POST",
			data: "ctgbic="+ctgbic,
...
<center>
					<div class="grupo">
						<div class="caja">
							<form id="eliminagbic" name="eliminagbic" method="POST" action="return false" onsubmit="return false">
<table class="formsadmin">
<tr><th><h2>Registrar Gbic con falla</h2></th></tr>
<tr><td><br><input type="text" title="Ejemplo: 2M26123123" name="ctgbic" form="eliminagbic" class="inputl" id="ctgbic" required placeholder="Ct de Gbic" minlength="8" maxlength="12"></td></tr>


<tr><td ><br><br><button name="Registrar" form="eliminagbic" style="width:400px;" class="btn1" id="Registrar"
onclick="Validar(document.getElementById('ctgbic').value);">Registrar</button></td></tr>
<tr><td><br><div id="resultado" style="font-size:22px;">&nbsp;</div></td></tr>
<tr><td><br><button class="btn1" form="none" onclick="location.href = 'administrar.php'">volver</button></td></tr>
</table>
