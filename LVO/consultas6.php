...
$constr1 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-81'");
if ($contr1 = mysqli_fetch_array($constr1)) {
  $NoSerie1 = $contr1['NoSerie'];
} else {
  $constr1 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-81' AND area='LVO'");
  if ($contr1 = mysqli_fetch_array($constr1)) {
    $NoSerie1 = $contr1['NoSerie'];
  } else {
    $NoSerie1 = "Disponible";
...
$constr2 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-82'");
if ($contr2 = mysqli_fetch_array($constr2)) {
  $NoSerie2 = $contr2['NoSerie'];
} else {
  $constr2 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-82' AND area='LVO'");
  if ($contr2 = mysqli_fetch_array($constr2)) {
    $NoSerie2 = $contr2['NoSerie'];
  } else {
    $NoSerie2 = "Disponible";
...
$constr3 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-83'");
if ($contr3 = mysqli_fetch_array($constr3)) {
  $NoSerie3 = $contr3['NoSerie'];
} else {
  $constr3 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-83' AND area='LVO'");
  if ($contr3 = mysqli_fetch_array($constr3)) {
    $NoSerie3 = $contr3['NoSerie'];
  } else {
    $NoSerie3 = "Disponible";
...
$constr4 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-84'");
if ($contr4 = mysqli_fetch_array($constr4)) {
  $NoSerie4 = $contr4['NoSerie'];
} else {
  $constr4 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-84' AND area='LVO'");
  if ($contr4 = mysqli_fetch_array($constr4)) {
    $NoSerie4 = $contr4['NoSerie'];
  } else {
    $NoSerie4 = "Disponible";
...
$constr5 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-85'");
if ($contr5 = mysqli_fetch_array($constr5)) {
  $NoSerie5 = $contr5['NoSerie'];
} else {
  $constr5 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-85' AND area='LVO'");
  if ($contr5 = mysqli_fetch_array($constr5)) {
    $NoSerie5 = $contr5['NoSerie'];
  } else {
    $NoSerie5 = "Disponible";
...
$constr6 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-86'");
if ($contr6 = mysqli_fetch_array($constr6)) {
  $NoSerie6 = $contr6['NoSerie'];
} else {
  $constr6 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-86' AND area='LVO'");
  if ($contr6 = mysqli_fetch_array($constr6)) {
    $NoSerie6 = $contr6['NoSerie'];
  } else {
    $NoSerie6 = "Disponible";
...
$constr7 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-87'");
if ($contr7 = mysqli_fetch_array($constr7)) {
  $NoSerie7 = $contr6['NoSerie'];
} else {
  $constr7 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-87' AND area='LVO'");
  if ($contr7 = mysqli_fetch_array($constr7)) {
    $NoSerie7 = $contr6['NoSerie'];
  } else {
    $NoSerie7 = "Disponible";
...
$constr8 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-88'");
if ($contr8 = mysqli_fetch_array($constr8)) {
  $NoSerie8 = $contr8['NoSerie'];
} else {
  $constr8 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-88' AND area='LVO'");
  if ($contr8 = mysqli_fetch_array($constr8)) {
    $NoSerie8 = $contr8['NoSerie'];
  } else {
    $NoSerie8 = "Disponible";
...
$constr9 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-89'");
if ($contr9 = mysqli_fetch_array($constr9)) {
  $NoSerie9 = $contr9['NoSerie'];
} else {
  $constr9 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-89' AND area='LVO'");
  if ($contr9 = mysqli_fetch_array($constr9)) {
    $NoSerie9 = $contr9['NoSerie'];
  } else {
    $NoSerie9 = "Disponible";
...
$constr10 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-90'");
if ($contr10 = mysqli_fetch_array($constr10)) {
  $NoSerie10 = $contr10['NoSerie'];
} else {
  $constr10 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-90' AND area='LVO'");
  if ($contr10 = mysqli_fetch_array($constr10)) {
    $NoSerie10 = $contr10['NoSerie'];
  } else {
    $NoSerie10 = "Disponible";
  }
}

$constr11 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-91'");
if ($contr11 = mysqli_fetch_array($constr11)) {
$NoSerie11 = $contr11['NoSerie'];
} else {
$constr11 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-91' AND area='LVO'");
if ($contr11 = mysqli_fetch_array($constr11)) {
$NoSerie11 = $contr11['NoSerie'];
} else {
$NoSerie11 = "Disponible";
}
}

$constr12 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-92'");
if ($contr12 = mysqli_fetch_array($constr12)) {
$NoSerie12 = $contr12['NoSerie'];
} else {
$constr12 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-92' AND area='LVO'");
if ($contr12 = mysqli_fetch_array($constr12)) {
$NoSerie12 = $contr12['NoSerie'];
} else {
$NoSerie12 = "Disponible";
}
}

$constr13 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-93'");
if ($contr13 = mysqli_fetch_array($constr13)) {
$NoSerie13 = $contr13['NoSerie'];
} else {
$constr13 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-93' AND area='LVO'");
if ($contr13 = mysqli_fetch_array($constr13)) {
$NoSerie13 = $contr13['NoSerie'];
} else {
$NoSerie13 = "Disponible";
}
}

$constr14 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-94'");
if ($contr14 = mysqli_fetch_array($constr14)) {
$NoSerie14 = $contr14['NoSerie'];
} else {
$constr14 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-94' AND area='LVO'");
if ($contr14 = mysqli_fetch_array($constr14)) {
$NoSerie14 = $contr14['NoSerie'];
} else {
$NoSerie14 = "Disponible";
}
}

$constr15 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-95'");
if ($contr15 = mysqli_fetch_array($constr15)) {
$NoSerie15 = $contr15['NoSerie'];
} else {
$constr15 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-95' AND area='LVO'");
if ($contr15 = mysqli_fetch_array($constr15)) {
$NoSerie15 = $contr15['NoSerie'];
} else {
$NoSerie15 = "Disponible";
}
}

$constr16 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-96'");
if ($contr16 = mysqli_fetch_array($constr16)) {
$NoSerie16 = $contr16['NoSerie'];
} else {
$constr16 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-96' AND area='LVO'");
if ($contr16 = mysqli_fetch_array($constr16)) {
$NoSerie16 = $contr16['NoSerie'];
} else {
$NoSerie16 = "Disponible";
}
}

$constr17 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-97'");
if ($contr16 = mysqli_fetch_array($constr17)) {
$NoSerie17 = $contr16['NoSerie'];
} else {
$constr17 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-97' AND area='LVO'");
if ($contr16 = mysqli_fetch_array($constr17)) {
$NoSerie17 = $contr16['NoSerie'];
} else {
$NoSerie17 = "Disponible";
}
}

$constr18 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-98'");
if ($contr18 = mysqli_fetch_array($constr18)) {
$NoSerie18 = $contr18['NoSerie'];
} else {
$constr18 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-98' AND area='LVO'");
if ($contr18 = mysqli_fetch_array($constr18)) {
$NoSerie18 = $contr18['NoSerie'];
} else {
$NoSerie18 = "Disponible";
}
}

$constr19 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-99'");
if ($contr19 = mysqli_fetch_array($constr19)) {
$NoSerie19 = $contr19['NoSerie'];
} else {
$constr19 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-99' AND area='LVO'");
if ($contr19 = mysqli_fetch_array($constr19)) {
$NoSerie19 = $contr19['NoSerie'];
} else {
$NoSerie19 = "Disponible";
}
}

$constr20 = mysqli_query($enlace, "SELECT * FROM racks WHERE Locacion = 'TR06-100'");
if ($contr20 = mysqli_fetch_array($constr20)) {
$NoSerie20 = $contr20['NoSerie'];
} else {
$constr20 = mysqli_query($enlace, "SELECT * FROM racksjv WHERE Locacion = 'TR06-100' AND area='LVO'");
if ($contr20 = mysqli_fetch_array($constr20)) {
$NoSerie20 = $contr20['NoSerie'];
} else {
$NoSerie20 = "Disponible";
}
}
...
/*------------------------------------------------------------------------------------------------------------------------------------------------------------*/					
					...
					$Prueba15="&nbsp;"; $Prueba16="&nbsp;";$Prueba17="&nbsp;";$Prueba18="&nbsp;";$Prueba20="&nbsp;";$Prueba20="&nbsp;";
/*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
for ($i = 1; $i <= 20; $i++) {
	...
	if ($contr['Modelo'] == "Azure 4.1" || $contr['Modelo'] == "Dropbox") {
	  $table = "pruebas";
	} else if ($contr['Modelo'] == "Microsoft") {
	  $table = "pruebasjv";
	}
	
	${"conp".$i} = mysqli_query($enlace, "SELECT * FROM $table WHERE NoSerie = '$NoSerie'");
  }
...
/*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
if($contr17['Modelo']=="Azure 4.1"){
	if($consp17=mysqli_fetch_array($conp17)){ 
	   if($consp17['FTO']==0){$Prueba17="FTO"; $FTOcount=$FTOcount+1;} 
	   elseif($consp17['Cisco']==0){$Prueba17="Configurar Cisco"; $Ciscocount=$Ciscocount+1; } elseif($consp17['Rackscan']==0){$Prueba17="Rackscan"; $Rackscancount=$Rackscancount+1;} 
	   elseif($consp17['XTEE']==0){$Prueba17="XTEE";  $XTEEcount=$XTEEcount+1;} elseif($consp17['Cluster']==0){$Prueba17="Cluster"; $Clustercount=$Clustercount+1;} 
	   elseif($consp17['Solar']==0){$Prueba17="Solar"; $Solarcount=$Solarcount+1;}elseif($consp17['Wiring']==0){$Prueba17="Wiringchek";$Wiringcount=$Wiringcount+1;}
	   elseif($consp17['Bootstrap']==0){$Prueba17="Bootstrap"; $Bootstrapcount=$Bootstrapcount+1;} elseif($consp17['Sharknado']==0){$Prueba17="Sharknado"; $Sharknadocount=$Sharknadocount+1;} 
	   elseif($consp17['DEID']==0){$Prueba17="DEID"; $DEIDcount=$DEIDcount+1;} elseif($consp17['Megamind']==0){$Prueba17="Megamind"; $Megacount=$Megacount+1;} 
	   elseif($consp17['EOTA']==0){$Prueba17="EOTA"; $EOTAcount=$EOTAcount+1;} else{$Prueba17="Terminado"; $Listocount=$Listocount+1;} }
   }elseif($contr17['Modelo']=="Dropbox"){
	   if($consp17=mysqli_fetch_array($conp17)){ 
	   if($consp17['FTO']==0){$Prueba17="FTO"; $FTOdcount=$FTOdcount+1;} 
	   elseif($consp17['Cisco']==0){$Prueba17="Configurar"; $Ciscodcount=$Ciscodcount+1;} elseif($consp17['Rackscan']==0){$Prueba17="Rackscan"; $Rackscandcount=$Rackscandcount+1;}
	   elseif($consp17['Solar']==0){$Prueba17="Solar 1";$Solardcount=$Solardcount+1;} elseif($consp17['Cluster']==0){$Prueba17="Cluster"; $Clusterdcount=$Clusterdcount+1;} 
	   elseif($consp17['Solar2']==0){$Prueba17="Solar 2";$Solar2dcount=$Solar2dcount+1;} elseif($consp17['Sharknado']==0){$Prueba17="Sharknado"; $Sharknadodcount=$Sharknadodcount+1;}
	   elseif($consp17['Wiring']==0){$Prueba17="Wiringcheck"; $Wiringdcount=$Wiringdcount+1;} elseif($consp17['DEID']==0){$Prueba17="DEID"; $DEIDdcount=$DEIDdcount+1;}
	   elseif($consp17['Megamind']==0){$Prueba17="Megamind"; $Megadcount=$Megadcount+1;} elseif($consp17['EOTA']==0){$Prueba17="EOTA"; $EOTAdcount=$EOTAdcount+1;}
		else{$Prueba17="Terminado"; $Listodcount=$Listodcount+1;}}
   }elseif($contr17['Modelo']=="Microsoft"){
	if($consp17=mysqli_fetch_array($conp17)){ 
	   if($consp17['FTO']==0){$Prueba17="FTO"; $FTOmcount++;} 
	   elseif($consp17['Arista0']==0){$Prueba17="Conf. Arista 0"; $Arista0mcount++; } elseif($consp17['Arista1']==0){$Prueba17="Conf. Arista 1"; $Arista1mcount++;} 
	   elseif($consp17['CM']==0){$Prueba17="CM"; $CMmCount++;} elseif($consp17['Cluster0']==0){$Prueba17="Cluster Nic 0"; $Cluster0mcount++;} elseif($consp17['Cluster1']==0){$Prueba17="Cluster Nic 1"; $Cluster1mcount++;} elseif($consp17['Bootstrap']==0){$Prueba17="Bootstrap"; $Bootstrapmcount++;} 
	   elseif($consp17['Rackscan']==0){$Prueba17="Rackscan"; $Rackscanmcount++;} elseif($consp17['DEID']==0){$Prueba17="DEID";$DEIDmcount++;}
	   elseif($consp17['EOTA']==0){$Prueba17="EOTA"; $EOTAmcount++;} else{$Prueba17="Terminado"; $Listomcount=$Listomcount+1;} }
   }
   /*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
   if($contr18['Modelo']=="Azure 4.1"){
	if($consp18=mysqli_fetch_array($conp18)){ 
	   if($consp18['FTO']==0){$Prueba18="FTO"; $FTOcount=$FTOcount+1;} 
	   elseif($consp18['Cisco']==0){$Prueba18="Configurar Cisco"; $Ciscocount=$Ciscocount+1; } elseif($consp18['Rackscan']==0){$Prueba18="Rackscan"; $Rackscancount=$Rackscancount+1;} 
	   elseif($consp18['XTEE']==0){$Prueba18="XTEE";  $XTEEcount=$XTEEcount+1;} elseif($consp18['Cluster']==0){$Prueba18="Cluster"; $Clustercount=$Clustercount+1;} 
	   elseif($consp18['Solar']==0){$Prueba18="Solar"; $Solarcount=$Solarcount+1;}elseif($consp18['Wiring']==0){$Prueba18="Wiringchek";$Wiringcount=$Wiringcount+1;}
	   elseif($consp18['Bootstrap']==0){$Prueba18="Bootstrap"; $Bootstrapcount=$Bootstrapcount+1;} elseif($consp18['Sharknado']==0){$Prueba18="Sharknado"; $Sharknadocount=$Sharknadocount+1;} 
	   elseif($consp18['DEID']==0){$Prueba18="DEID"; $DEIDcount=$DEIDcount+1;} elseif($consp18['Megamind']==0){$Prueba18="Megamind"; $Megacount=$Megacount+1;} 
	   elseif($consp18['EOTA']==0){$Prueba18="EOTA"; $EOTAcount=$EOTAcount+1;} else{$Prueba18="Terminado"; $Listocount=$Listocount+1;} }
   }elseif($contr18['Modelo']=="Dropbox"){
	   if($consp18=mysqli_fetch_array($conp18)){ 
	   if($consp18['FTO']==0){$Prueba18="FTO"; $FTOdcount=$FTOdcount+1;} 
	   elseif($consp18['Cisco']==0){$Prueba18="Configurar"; $Ciscodcount=$Ciscodcount+1;} elseif($consp18['Rackscan']==0){$Prueba18="Rackscan"; $Rackscandcount=$Rackscandcount+1;}
	   elseif($consp18['Solar']==0){$Prueba18="Solar 1";$Solardcount=$Solardcount+1;} elseif($consp18['Cluster']==0){$Prueba18="Cluster"; $Clusterdcount=$Clusterdcount+1;} 
	   elseif($consp18['Solar2']==0){$Prueba18="Solar 2";$Solar2dcount=$Solar2dcount+1;} elseif($consp18['Sharknado']==0){$Prueba18="Sharknado"; $Sharknadodcount=$Sharknadodcount+1;}
	   elseif($consp18['Wiring']==0){$Prueba18="Wiringcheck"; $Wiringdcount=$Wiringdcount+1;} elseif($consp18['DEID']==0){$Prueba18="DEID"; $DEIDdcount=$DEIDdcount+1;}
	   elseif($consp18['Megamind']==0){$Prueba18="Megamind"; $Megadcount=$Megadcount+1;} elseif($consp18['EOTA']==0){$Prueba18="EOTA"; $EOTAdcount=$EOTAdcount+1;}
		else{$Prueba18="Terminado"; $Listodcount=$Listodcount+1;}}
   }elseif($contr18['Modelo']=="Microsoft"){
	if($consp18=mysqli_fetch_array($conp18)){ 
	   if($consp18['FTO']==0){$Prueba18="FTO"; $FTOmcount++;} 
	   elseif($consp18['Arista0']==0){$Prueba18="Conf. Arista 0"; $Arista0mcount++; } elseif($consp18['Arista1']==0){$Prueba18="Conf. Arista 1"; $Arista1mcount++;} 
	   elseif($consp18['CM']==0){$Prueba18="CM"; $CMmCount++;} elseif($consp18['Cluster0']==0){$Prueba18="Cluster Nic 0"; $Cluster0mcount++;} elseif($consp18['Cluster1']==0){$Prueba18="Cluster Nic 1"; $Cluster1mcount++;} elseif($consp18['Bootstrap']==0){$Prueba18="Bootstrap"; $Bootstrapmcount++;} 
	   elseif($consp18['Rackscan']==0){$Prueba18="Rackscan"; $Rackscanmcount++;} elseif($consp18['DEID']==0){$Prueba18="DEID";$DEIDmcount++;}
	   elseif($consp18['EOTA']==0){$Prueba18="EOTA"; $EOTAmcount++;} else{$Prueba18="Terminado"; $Listomcount=$Listomcount+1;} }
   }

/*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
if($contr19['Modelo']=="Azure 4.1"){
	if($consp19=mysqli_fetch_array($conp19)){ 
	   if($consp19['FTO']==0){$Prueba19="FTO"; $FTOcount=$FTOcount+1;} 
	   elseif($consp19['Cisco']==0){$Prueba19="Configurar Cisco"; $Ciscocount=$Ciscocount+1; } elseif($consp19['Rackscan']==0){$Prueba19="Rackscan"; $Rackscancount=$Rackscancount+1;} 
	   elseif($consp19['XTEE']==0){$Prueba19="XTEE";  $XTEEcount=$XTEEcount+1;} elseif($consp19['Cluster']==0){$Prueba19="Cluster"; $Clustercount=$Clustercount+1;} 
	   elseif($consp19['Solar']==0){$Prueba19="Solar"; $Solarcount=$Solarcount+1;}elseif($consp19['Wiring']==0){$Prueba19="Wiringchek";$Wiringcount=$Wiringcount+1;}
	   elseif($consp19['Bootstrap']==0){$Prueba19="Bootstrap"; $Bootstrapcount=$Bootstrapcount+1;} elseif($consp19['Sharknado']==0){$Prueba19="Sharknado"; $Sharknadocount=$Sharknadocount+1;} 
	   elseif($consp19['DEID']==0){$Prueba19="DEID"; $DEIDcount=$DEIDcount+1;} elseif($consp19['Megamind']==0){$Prueba19="Megamind"; $Megacount=$Megacount+1;} 
	   elseif($consp19['EOTA']==0){$Prueba19="EOTA"; $EOTAcount=$EOTAcount+1;} else{$Prueba19="Terminado"; $Listocount=$Listocount+1;} }
   }elseif($contr19['Modelo']=="Dropbox"){
	   if($consp19=mysqli_fetch_array($conp19)){ 
	   if($consp19['FTO']==0){$Prueba19="FTO"; $FTOdcount=$FTOdcount+1;} 
	   elseif($consp19['Cisco']==0){$Prueba19="Configurar"; $Ciscodcount=$Ciscodcount+1;} elseif($consp19['Rackscan']==0){$Prueba19="Rackscan"; $Rackscandcount=$Rackscandcount+1;}
	   elseif($consp19['Solar']==0){$Prueba19="Solar 1";$Solardcount=$Solardcount+1;} elseif($consp19['Cluster']==0){$Prueba19="Cluster"; $Clusterdcount=$Clusterdcount+1;} 
	   elseif($consp19['Solar2']==0){$Prueba19="Solar 2";$Solar2dcount=$Solar2dcount+1;} elseif($consp19['Sharknado']==0){$Prueba19="Sharknado"; $Sharknadodcount=$Sharknadodcount+1;}
	   elseif($consp19['Wiring']==0){$Prueba19="Wiringcheck"; $Wiringdcount=$Wiringdcount+1;} elseif($consp19['DEID']==0){$Prueba19="DEID"; $DEIDdcount=$DEIDdcount+1;}
	   elseif($consp19['Megamind']==0){$Prueba19="Megamind"; $Megadcount=$Megadcount+1;} elseif($consp19['EOTA']==0){$Prueba19="EOTA"; $EOTAdcount=$EOTAdcount+1;}
		else{$Prueba19="Terminado"; $Listodcount=$Listodcount+1;}}
   }elseif($contr19['Modelo']=="Microsoft"){
	if($consp19=mysqli_fetch_array($conp19)){ 
	   if($consp19['FTO']==0){$Prueba19="FTO"; $FTOmcount++;} 
	   elseif($consp19['Arista0']==0){$Prueba19="Conf. Arista 0"; $Arista0mcount++; } elseif($consp19['Arista1']==0){$Prueba19="Conf. Arista 1"; $Arista1mcount++;} 
	   elseif($consp19['CM']==0){$Prueba19="CM"; $CMmCount++;} elseif($consp19['Cluster0']==0){$Prueba19="Cluster Nic 0"; $Cluster0mcount++;} elseif($consp19['Cluster1']==0){$Prueba19="Cluster Nic 1"; $Cluster1mcount++;} elseif($consp19['Bootstrap']==0){$Prueba19="Bootstrap"; $Bootstrapmcount++;} 
	   elseif($consp19['Rackscan']==0){$Prueba19="Rackscan"; $Rackscanmcount++;} elseif($consp19['DEID']==0){$Prueba19="DEID";$DEIDmcount++;}
	   elseif($consp19['EOTA']==0){$Prueba19="EOTA"; $EOTAmcount++;} else{$Prueba19="Terminado"; $Listomcount=$Listomcount+1;} }
   }

   /*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
if($contr20['Modelo']=="Azure 4.1"){
	if($consp20=mysqli_fetch_array($conp20)){ 
	   if($consp20['FTO']==0){$Prueba20="FTO"; $FTOcount=$FTOcount+1;} 
	   elseif($consp20['Cisco']==0){$Prueba20="Configurar Cisco"; $Ciscocount=$Ciscocount+1; } elseif($consp20['Rackscan']==0){$Prueba20="Rackscan"; $Rackscancount=$Rackscancount+1;} 
	   elseif($consp20['XTEE']==0){$Prueba20="XTEE";  $XTEEcount=$XTEEcount+1;} elseif($consp20['Cluster']==0){$Prueba20="Cluster"; $Clustercount=$Clustercount+1;} 
	   elseif($consp20['Solar']==0){$Prueba20="Solar"; $Solarcount=$Solarcount+1;}elseif($consp20['Wiring']==0){$Prueba20="Wiringchek";$Wiringcount=$Wiringcount+1;}
	   elseif($consp20['Bootstrap']==0){$Prueba20="Bootstrap"; $Bootstrapcount=$Bootstrapcount+1;} elseif($consp20['Sharknado']==0){$Prueba20="Sharknado"; $Sharknadocount=$Sharknadocount+1;} 
	   elseif($consp20['DEID']==0){$Prueba20="DEID"; $DEIDcount=$DEIDcount+1;} elseif($consp20['Megamind']==0){$Prueba20="Megamind"; $Megacount=$Megacount+1;} 
	   elseif($consp20['EOTA']==0){$Prueba20="EOTA"; $EOTAcount=$EOTAcount+1;} else{$Prueba20="Terminado"; $Listocount=$Listocount+1;} }
   }elseif($contr20['Modelo']=="Dropbox"){
	   if($consp20=mysqli_fetch_array($conp20)){ 
	   if($consp20['FTO']==0){$Prueba20="FTO"; $FTOdcount=$FTOdcount+1;} 
	   elseif($consp20['Cisco']==0){$Prueba20="Configurar"; $Ciscodcount=$Ciscodcount+1;} elseif($consp20['Rackscan']==0){$Prueba20="Rackscan"; $Rackscandcount=$Rackscandcount+1;}
	   elseif($consp20['Solar']==0){$Prueba20="Solar 1";$Solardcount=$Solardcount+1;} elseif($consp20['Cluster']==0){$Prueba20="Cluster"; $Clusterdcount=$Clusterdcount+1;} 
	   elseif($consp20['Solar2']==0){$Prueba20="Solar 2";$Solar2dcount=$Solar2dcount+1;} elseif($consp20['Sharknado']==0){$Prueba20="Sharknado"; $Sharknadodcount=$Sharknadodcount+1;}
	   elseif($consp20['Wiring']==0){$Prueba20="Wiringcheck"; $Wiringdcount=$Wiringdcount+1;} elseif($consp20['DEID']==0){$Prueba20="DEID"; $DEIDdcount=$DEIDdcount+1;}
	   elseif($consp20['Megamind']==0){$Prueba20="Megamind"; $Megadcount=$Megadcount+1;} elseif($consp20['EOTA']==0){$Prueba20="EOTA"; $EOTAdcount=$EOTAdcount+1;}
		else{$Prueba20="Terminado"; $Listodcount=$Listodcount+1;}}
   }elseif($contr20['Modelo']=="Microsoft"){
	if($consp20=mysqli_fetch_array($conp20)){ 
	   if($consp20['FTO']==0){$Prueba20="FTO"; $FTOmcount++;} 
	   elseif($consp20['Arista0']==0){$Prueba20="Conf. Arista 0"; $Arista0mcount++; } elseif($consp20['Arista1']==0){$Prueba20="Conf. Arista 1"; $Arista1mcount++;} 
	   elseif($consp20['CM']==0){$Prueba20="CM"; $CMmCount++;} elseif($consp20['Cluster0']==0){$Prueba20="Cluster Nic 0"; $Cluster0mcount++;} elseif($consp20['Cluster1']==0){$Prueba20="Cluster Nic 1"; $Cluster1mcount++;} elseif($consp20['Bootstrap']==0){$Prueba20="Bootstrap"; $Bootstrapmcount++;} 
	   elseif($consp20['Rackscan']==0){$Prueba20="Rackscan"; $Rackscanmcount++;} elseif($consp20['DEID']==0){$Prueba20="DEID";$DEIDmcount++;}
	   elseif($consp20['EOTA']==0){$Prueba20="EOTA"; $EOTAmcount++;} else{$Prueba20="Terminado"; $Listomcount=$Listomcount+1;} }
   }
/*--------
/*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
// consultas jv
